...
import com.mindgate.main.repository.Candidate_repo_Interface;
@Service
public class Candidate_Service implements Candidate_Service_Interface {

	@Autowired
	private Candidate_repo_Interface candidate_repo_Interface;
	@Override
